...
const Footer = () => {
  return (
    <footer className="footer sm:footer-horizontal flex items-center justify-between p-4 fixed bottom-0 left-0 w-full bg-base-100">
  <aside className="grid-flow-col items-center">
   
    <p className='text-blue-500'>© hv {new Date().getFullYear()}</p>
  </aside>
